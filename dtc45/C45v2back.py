...
class C45v2back:
    ...
    def fitInternal(self, currentData, parentId, parent_edge):
        ...
        if (len(curr_target) == 1):
            self.tree.append([cur_idx, parentId, None, None, 0.0, 0.0, parent_edge, 0.0, curr_target[0], targetCompostion])
            print("......  Fitting " + str(self.currNumNode) + " nd node, parent id : " + str(parentId) + ", parent edge :" + str(parent_edge) + " ...... Done!!!\n")
            return
        ...
        if (currentData.shape[1] < 2):
            ...
            self.tree.append([cur_idx, parentId, None, None, 0.0, 0.0, parent_edge, 0.0, selected_class, targetCompostion])
            print("......  Fitting " + str(self.currNumNode) + " nd node, parent id : " + str(parentId) + ", parent edge :" + str(parent_edge) + " ...... Done!!!\n")
            return
        ## Check terminate condition
        ...
        self.tree.append([cur_idx, parentId, cur_attr_name, self.attributes_info[cur_attr_name]['col_idx'], cur_gain, cur_split_info, cur_edge, cur_threshold, None,targetCompostion ])
